...
--
-- Host: 127.0.0.1    Database: introdb64992
-- ------------------------------------------------------
...
INSERT INTO `billeteras` VALUES (1,'Ledger Nano S',16000.00,30),(2,'Trezor One',19500.00,30),(3,'Trezor T',78000.00,20),(4,'Ledger Nano X',58800.00,20),(5,'Dcent',50000.00,10);
...
CREATE TABLE `destinos` (
  ...
  KEY `destinos_regiones` (`idRegion`),
  CONSTRAINT `destinos_regiones` FOREIGN KEY (`idRegion`) REFERENCES `regiones` (`idRegion`)
...
-- Dump completed on 2023-04-19 11:55:04
